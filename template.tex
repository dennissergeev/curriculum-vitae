...
$if(education.supervisor)$\href{mailto:$education.superemail$}{$education.supervisor$}\\$endif$
$endfor$
\vspace{20pt}
...
\noindent
$for(internships)$
\note{$internships.years$}$if(internships.institution)$\emph{$internships.institution$}\\$endif$
$if(internships.department)$\emph{$internships.department$}\\$endif$
$if(internships.location)$\emph{$internships.location$}\\$endif$
$if(internships.supervisor)$\href{mailto:$internships.superemail$}{$internships.supervisor$}\\$endif$
$endfor$
\vspace{20pt}
$endif$
